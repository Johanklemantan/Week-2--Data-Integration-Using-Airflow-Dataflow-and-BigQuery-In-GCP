...
with models.DAG(
    ...
    load_to_bigquery = DataflowTemplateOperator(
        ...
        parameters={
            ...
            "JSONPath": bucket_path + "/bucket/schema.json",
            "javascriptTextTransformGcsPath": bucket_path + "/bucket/transform.js",
            "inputFilePattern": bucket_path + "/keyword_search_search_{{ ds_nodash }}.csv",
            "outputTable": project_id + ":searched_keyword.tugas1a",
